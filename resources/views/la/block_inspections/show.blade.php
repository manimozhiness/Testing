...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $block_inspection->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Block_Inspections", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/block_inspections/'.$block_inspection->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Block_Inspections", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.block_inspections.destroy', $block_inspection->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/block_inspections') }}" data-toggle="tooltip" data-placement="right" title="Back to Block Inspections"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'Quarry_Code')
						@la_display($module, 'Block_No')
						@la_display($module, 'Block_Size')
						@la_display($module, 'Size_Code')
						@la_display($module, 'date_Marking')
						@la_display($module, 'marker_Name')
