...
@section('sidebar')
<li class="active"><a href="#sra" data-toggle="tab"><i class="fa fa-balance-scale"></i> <span> SRA</span></a></li>
<li><a href="#rfx" data-toggle="tab"><i class="fa fa-quote-left"></i> <span> RFx</span></a></li>
@endsection
@section('title')
<h1>
  Suppliers
...
<ol class="breadcrumb">
  ...
  <li><a class="active"><i class="fa fa-gears"></i> Suppliers</a></li>
</ol>
@endsection
@section('content')
<div class="row">
  <div class="col-sm-12">
    <div class="tab-content">
              <div class="tab-pane active" id="sra">
                <div class="row">
                <h4 class="col-sm-12">Supplier Risk Assessment</h4><br>
              ...
              <!-- /.tab-pane -->
              <div class="tab-pane" id="rfx">
                  <div class="row">
                  <h4 class="col-sm-12">RFx Management</h4><br>
                  <div class="col-sm-6 col-md-4">
                  <div class="box box-solid">
                        <div class="box-header with-border">
                            <i class="ion ion-ios-speedometer-outline"></i>
